...
const EnhancedLiveClassInterface: React.FC<EnhancedLiveClassInterfaceProps> = ({ 
  sessionId, 
  isHost, 
  onLeave 
}) => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    {
      ...
      message: 'Hello everyone! Excited for today\'s class.',
    ...
    },
    {
      ...
      message: 'Can you please explain the differentiation formula again?',
  ...
  const sendChatMessage = () => {
    ...
    const newMessage: ChatMessage = {
      ...
      participantId: '1',
      participantName: 'Dr. Sarah Wilson (You)',
      message: chatMessage,
      timestamp: new Date()
    };
  ...
  const raisedHandsCount = participants.filter(p => p.hasRaisedHand).length;
